...
const GetType = () => {
  ...
  const handleConfirm = async () => {
    try {
      const getData = await axios.delete(
        `http://localhost:8000/tipe/${idTipe}`,
        config
      );
  ...
  return (
    <div>
                    ...
                    key === "foto" ? (
                      <tr key={key}>
                        ...
                        <td>
                          {" "}
                          <Image
                            src={`http://localhost:8000/foto_tipe/${value}`}
                            alt="user foto"
                            width={200}
                            height={200}
      ...
      <Button
        variant="outlined"
        onClick={() => router.push("/admin/roomType/AddType")}
        sx={{
          marginTop: "2rem",
          color: "#024f79",
          borderColor: "#024f79",
                  ...
                  currentData.map((item, index) => (
                    <StyledTableRow key={index}>
                      ...
                      <StyledTableCell align="center">
                        ...
                        >
                          <Link href={`/admin/roomType/UpdateType/${item.id}`}>
                            edit
                          </Link>
                        </Button>
                        <Button
...
export default withAuth(GetType);
