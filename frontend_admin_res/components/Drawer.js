...
function ResponsiveDrawer() {
  ...
  // let nama_user = "";
  useEffect(()=>{
   setNamaUser(window.localStorage.getItem('nama_user'));
  },[])
  ...
  const drawer = (
    <div>
      ...
      />
      <Divider />
      <div style={{display:"flex", padding:"1rem", gap:"10px", alignItems:"center"}}>
        <GrUserAdmin style={{ fontSize:"large" }}/>
        <div style={{ fontWeight:"bold", color:color }}>{nama_user}</div>
      </div>
      <Divider />
